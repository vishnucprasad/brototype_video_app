...
import 'package:brototype_video_app/application/admin/admin_auth/admin_auth_bloc.dart'
    as _i8;
import 'package:brototype_video_app/application/admin/admin_bloc.dart' as _i9;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i6.IAdminRepository>(() => _i7.AdminRepository());
    gh.factory<_i8.AdminAuthBloc>(() => _i8.AdminAuthBloc(
          gh<_i4.IAdminAuthFacade>(),
          gh<_i6.IAdminRepository>(),
        ));
    gh.factory<_i9.AdminBloc>(() => _i9.AdminBloc(
          gh<_i4.IAdminAuthFacade>(),
          gh<_i6.IAdminRepository>(),
        ));
    gh.factory<_i10.AdminLoginFormBloc>(
        () => _i10.AdminLoginFormBloc(gh<_i4.IAdminAuthFacade>()));
    gh.factory<_i11.CreateBatchFormBloc>(() => _i11.CreateBatchFormBloc(
          gh<_i4.IAdminAuthFacade>(),
          gh<_i6.IAdminRepository>(),
        ));
    return this;
